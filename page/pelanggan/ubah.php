        ...
        <div class="col-md-6">
            ...
            <form method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="<?php echo $data['telpone'] ?>" name="telpone">
                </div>
          ...
          <?php 
                ...
                if(isset($_POST['simpan'])) {
                    ...
                    $sql2 = $koneksi->query(" update tb_pelanggan set nama='$nama', telpone='$telpone', alamat='$alamat' where 
                        kode_pelanggan='$kode' ");
