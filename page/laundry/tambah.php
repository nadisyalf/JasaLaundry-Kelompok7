        ...
        <div class="col-md-6">
          ...
          <?php 
                ...
                if(isset($_POST['simpan'])) {
                    ...
                    $sql = $koneksi->query("insert into tb_laundry (id_pelanggan, kode_user, tanggal_terima, tanggal_selesai, jumlah_kiloan, nominal, status, catatan)
                    values('$pelanggan', '$id_user', '$tgl_terima', '$tgl_selesai', '$jumlah_kiloan', '$total', '$status', '$catatan') ");
                    ...
                    if ($sql) {
                      ...
                      if ($status=="Lunas") {
                        $sql = $koneksi->query("insert into tb_transaksi (kode_user, tanggal_transaksi, pemasukan, catatan, keterangan)
